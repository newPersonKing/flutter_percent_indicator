...
class SampleLinearExtendPage extends StatefulWidget {
  @override
  _SampleLinearPageState createState() => _SampleLinearPageState();
}

class _SampleLinearPageState extends State<SampleLinearExtendPage> {
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: LinearPercentIndicatorExtend(
